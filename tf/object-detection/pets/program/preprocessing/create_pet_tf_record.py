...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '/tmp/dataset/', 'Root directory to raw pet dataset.')
flags.DEFINE_string('output_dir', '/opt/dkube/output', 'Path to directory to output TFRecords.')
