...
3. Once the tar ball is generated. Follow the procedure mentioned in [section](https://github.com/oneconvergence/dkube-examples/blob/master/tf/classification/resnet/catsdogs/README.md#How to use dkube_resnetv2_pl.tar.gz). 
