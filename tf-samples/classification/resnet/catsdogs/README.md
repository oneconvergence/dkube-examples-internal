...
## Step1: Create a workspace
 ...
 5. Paste link *[https://github.com/oneconvergence/dkube-examples/tree/master/tf-samples/mnist-digits/program](https://github.com/oneconvergence/dkube-examples/tree/master/tf-samples/mnist-digits/program)* in the URL text box.
...
## Step2: Create a dataset
 ...
 3. Select *Github* option.
 4. Enter a unique name say *mnist-digits*
 5. Paste link *[[https://github.com/oneconvergence/dkube-examples/tree/master/tf-samples/mnist-digits/tdata](https://github.com/oneconvergence/dkube-examples/tree/master/tf-samples/mnist-digits/tdata)]* in the URL text box.
...
2. Change the github url to [https://github.com/oneconvergence/dkube-examples/tree/master/tf-samples/classification/mnist/digits/pipeline/digits.ipynb](https://github.com/oneconvergence/dkube-examples/tree/master/tf-samples/classification/mnist/digits/pipeline/digits.ipynb)
