...
if __name__== "__main__":
    ...
    parser.add_argument("-f","--filename", dest = 'filename', required=True, help="input file path")
    parser.add_argument("-o","--outputfile", required=True, dest = 'outfile', help="output folder path")
