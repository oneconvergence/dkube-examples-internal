# Pet Detector
This example is derived from [tensorflow object detection example](https://github.com/tensorflow/models/tree/2.0.3/research/object_detection) and modified to run on Dkube Platform.
