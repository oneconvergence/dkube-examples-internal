...
# parses the given csv file line by line and returns results as a json list
...
def parse_csv_file(lst_path):
    parsed_results = []

    with open(lst_path) as train_lst:
        reader = csv.reader(train_lst)
        next(reader)
        for line_values in reader:
            image_name = "images/" + line_values[0]
            line_labels = line_values[1:]
...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
    ...
    parsed_lst_train = parse_csv_file(image_dir + '/dataset_train.csv')

    # load the validation set
    parsed_lst_validation = parse_csv_file(image_dir + '/dataset_validation.csv')
