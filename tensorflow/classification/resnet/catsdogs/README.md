...
## Step1: Create a workspace
 ...
 5. Paste link *[https://github.com/oneconvergence/dkube-examples/tree/1.2/tf-samples/classification/resnet/catsdogs/classifier/program](https://github.com/oneconvergence/dkube-examples/tree/1.2/tf-samples/classification/resnet/catsdogs/classifier/program)* in the URL text box.
...
## Step2: Create a dataset
 ...
 3. Select *Github* option.
 4. Enter a unique name say *resnet-catsdogs*
 5. Paste link *[[https://github.com/oneconvergence/dkube-examples/tree/1.2/tf-samples/classification/resnet/catsdogs/classifier/data](https://github.com/oneconvergence/dkube-examples/tree/1.2/tf-samples/classification/resnet/catsdogs/classifier/data)]* in the URL text box.
...
2. Change the github url to [https://github.com/oneconvergence/dkube-examples/tree/1.2/tf-samples/classification/resnet/catsdogs/pipeline/catsdogs.ipynb](https://github.com/oneconvergence/dkube-examples/tree/1.2/tf-samples/classification/resnet/catsdogs/pipeline/catsdogs.ipynb)
